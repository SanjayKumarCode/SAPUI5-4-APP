sap.ui.define([
    ...
    return Controller.extend("com.example.timmer.controller.SalesOrder.SalesOrder", {
      onInit: function(){
        var headerFragment = sap.ui.xmlfragment(this.getView().getId(),"com.example.timmer.view.SalesOrder.Items",this)
        this.getView().byId("main").insertContent(headerFragment);
        var filterFragment = sap.ui.xmlfragment(this.getView().getId(),"com.example.timmer.view.SalesOrder.Filter",this)
        ...
        this.oColModel = new JSONModel(cols);
          ...
          onValueHelpRequestedDel: function() {
              this._oValueHelpDialogDel = sap.ui.xmlfragment("com.example.timmer.view.SalesOrder.DelHelp", this);
      ...
      onValueHelpRequested: function() {
              ...
              this._oValueHelpDialog = sap.ui.xmlfragment("com.example.timmer.view.SalesOrder.BPHelp", this);
              this.getView().addDependent(this._oValueHelpDialog);
