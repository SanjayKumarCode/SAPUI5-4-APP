		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "timmer",
									"targetURL": "#comexampletimmer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletimmer-display": {
								"semanticObject": "comexampletimmer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.timmer",
									"url": sap.ui.require.toUrl("com/example/timmer")
								}
							}
						}
					}
